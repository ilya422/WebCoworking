...
router.get('/api/event_adv', authMiddleware, evAdvController.get_evAdvsForMain)
router.get('/api/event_adv/main/:id_tag', authMiddleware, evAdvController.get_evAdvByTag)
router.get('/api/event_adv/:id', authMiddleware, evAdvController.getOne_evAdv)
